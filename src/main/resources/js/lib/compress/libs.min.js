...
!function(u){u.fn.extend({dialog:{version:"0.0.1.7",author:"84588990@qq.com"}});function e(){this._defaults={styleClass:{background:"dialog-background",panel:"dialog-panel",main:"dialog-main",footer:"dialog-footer",headerMiddle:"dialog-header-middle",headerBg:"dialog-header-bg",closeIcon:"icon-close",closeIconHover:"dialog-close-icon-hover",title:"dialog-title"}}}var t=(new Date).getTime(),o="dialog";u.extend(e.prototype,{_attach:function(e,t){e.id||(this.uuid++,e.id="dp"+this.uuid);var i=this._newInst(u(e));i.settings=u.extend({},t||{}),u.data(e,o,i),this._init(e)},_newInst:function(e){return{id:e[0].id.replace(/([^A-Za-z0-9_])/g,"\\\\$1")}},_getInst:function(e){try{return u.data(e,o)}catch(e){throw"Missing instance data for this dialog"}},_destroyDialog:function(e){var t=u.dialog._getInst(e),i=t.id;u.removeData(e,o),u(e).prependTo("#"+i+"Wrap").unwrap(),u(e).removeAttr("style");t=this._getDefaults(u.dialog._defaults,t.settings,"styleClass");u("."+t.background).remove(),u("#"+i+"Dialog").remove()},_init:function(e){var t=this._getInst(e),i=t.id,o=t.settings,n=u(window).height(),s=u(window).width(),a=this._getDefaults(u.dialog._defaults,o,"styleClass"),l=o.height||parseInt(.6*n),d=o.width||parseInt(.6*s);o.title=o.title||"",o.okText=o.okText||"Ok",o.cancelText=o.cancelText||"Cancel";var c="",r="<div class='fn-clear "+a.headerBg+"'><div class='"+a.title+"'>"+o.title+"</div><a href='javascript:void(0);' class='"+a.closeIcon+"'><svg><use xlink:href='#close'></use></svg></a></div>";o.hideFooter||(c="<a href='javascript:void(0);'>"+o.okText+"</a><a href='javascript:void(0);'>"+o.cancelText+"</a>");t="<div id='"+i+"Dialog' class='"+a.panel+"' style='width: "+d+"px; height: "+l+"px;' onselectstart='return false;'>"+r+"<div class='"+a.main+"' style='overflow: auto;height:"+(l-53)+"px'><div class='"+a.footer+"'>"+c+"</div></div>",r="";o.modal&&0===u("."+a.background).length&&(r="<div style='height:"+(n<document.documentElement.scrollHeight?document.documentElement.scrollHeight:n)+"px;' class='"+a.background+"'></div>"),u("#"+i).wrap("<div id='"+i+"Wrap'></div>");c=u(e).clone(!0);u(e).remove(),u("body").append(r+t),u(u("#"+i+"Dialog ."+a.main+" div").get(0)).append(c),u(c).show();r="",t="",c=u("#"+i+"Dialog"),t=o.position?(r=o.position.top,o.position.left):(r=parseInt((n-l)/2),parseInt((s-d)/2));c.css({top:r+"px",left:t+"px"}),u("#"+i+"Dialog ."+a.closeIcon).bind("click",function(){u.dialog._close(i,o)});t=u("#"+i+"Dialog ."+a.footer+" a");u(t.get(1)).bind("click",function(){u.dialog._close(i,o)}),u(t.get(0)).bind("click",function(){void 0!==o.ok&&!o.ok()||u.dialog._close(i,o)}),this._bindMove(i,a.headerBg,l,d),u(window).keyup(function(e){27===e.keyCode&&u.dialog._close(i,o)})},_bindMove:function(s,e){u("#"+s+"Dialog ."+e).mousedown(function(e){var t=document;e=e||window.event;var i=document.getElementById(s+"Dialog"),o=e.clientX-parseInt(i.style.left),n=e.clientY-parseInt(i.style.top);t.ondragstart="return false;",t.onselectstart="return false;",t.onselect="document.selection.empty();",this.setCapture?this.setCapture():window.captureEvents&&window.captureEvents(Event.MOUSEMOVE|Event.MOUSEUP),t.onmousemove=function(e){var t=(e=e||window.event).clientX-o,e=e.clientY-n;t<0&&(t=0),t>u(window).width()-u(i).width()&&(t=u(window).width()-u(i).width()),e<0&&(e=0),e>u(window).height()-u(i).height()&&(e=u(window).height()-u(i).height()),i.style.left=t+"px",i.style.top=e+"px"},t.onmouseup=function(){this.releaseCapture?this.releaseCapture():window.captureEvents&&window.captureEvents(Event.MOUSEMOVE|Event.MOUSEUP),t.onmousemove=null,t.onmouseup=null,t.ondragstart=null,t.onselectstart=null,t.onselect=null}})},_close:function(e,t){"none"!==u("#"+e+"Dialog").css("display")&&(void 0!==t.close&&!t.close()||(u("#"+e+"Dialog").hide(),t.modal&&(t=this._getDefaults(u.dialog._defaults,t,"styleClass"),u("."+t.background).hide())))},_closeDialog:function(e){var t=this._getInst(e),e=t.id,t=t.settings;u.dialog._close(e,t)},_openDialog:function(e){var t=this._getInst(e),e=t.id,t=t.settings;u("#"+e+"Dialog").show(),t.modal&&(t=this._getDefaults(u.dialog._defaults,t,"styleClass"),u("."+t.background).show())},_updateDialog:function(e,t){var i=this._getInst(e),o=i.id,e=i.settings,i=this._getDefaults(u.dialog._defaults,e,"styleClass");u.extend(e,t);o=u("#"+o+"Dialog");t.position&&o.css({top:t.position.top,left:t.position.left}),t.width&&(o.width(t.width+26),o.find("."+i.main+" div")[0].style.width=t.width+"px",o.find("."+i.headerBg).width(t.width+18)),t.height&&(o.find("."+i.main+" div")[0].style.height=t.height+"px"),t.title&&o.find("."+i.title).html(t.title),void 0!==t.modal&&(t.modal?u("."+i.background).show():u("."+i.background).hide()),void 0!==t.hideFooter&&(t.hideFooter?o.find("."+i.footer).hide():o.find("."+i.footer).show())},_getDefaults:function(e,t,i){if("styleClass"===i){if("default"===t.theme||void 0===t.theme)return e.styleClass;for(var o in t.styleClass={},e[i])t.styleClass[o]=t.theme+"-"+e.styleClass[o]}else{if("height"===i||"width"===i)return null===t[i]||void 0===t[i]?"auto":t[i]+"px";if(null===t[i]||void 0===t[i])return e[i]}return t[i]}}),u.fn.dialog=function(e){var t=Array.prototype.slice.call(arguments);return"string"==typeof e?(t.shift(),u.dialog["_"+e+"Dialog"].apply(u.dialog,[this[0]].concat(t))):this.each(function(){u.dialog._attach(this,e)})},u.dialog=new e,window["DP_jQuery_"+t]=u}(jQuery),function(h){function e(){this._defaults={styleClass:{panelClass:"completed-panel",inputClass:"completed-input",ckClass:"completed-ck"},separator:","},this._settingsDataFormat={}}var t=(new Date).getTime(),o="completed";h.extend(e.prototype,{_attach:function(e,t){e.id||(this.uuid++,e.id="dp"+this.uuid);var i=this._newInst(h(e));i.settings=h.extend({buttonText:"选择"},t||{}),h.data(e,o,i),this._init(e)},_newInst:function(e){return{id:e[0].id.replace(/([^A-Za-z0-9_])/g,"\\\\$1")}},_getInst:function(e){try{return h.data(e,o)}catch(e){throw"Missing instance data for this completed"}},_destroyCompleted:function(){},_init:function(e){var e=this._getInst(e),t=e.id,e=e.settings;this._buildHTML(t,e),h(document).click(function(e){e.target.id!==t&&h("#"+t+"SelectedPanel").hide()}),e.onlySelect||this._buildCheckboxPanel(t,e.data)},_buildHTML:function(e,t){var i=t.height+"px",o=this._getDefaults(h.completed._defaults,t,"styleClass"),n=h("#"+e),s="";t.onlySelect||(s+="<button onclick=\"$('#"+e+"CheckboxPanel').toggle()\">"+t.buttonText+"</button>"),s+="<div id='"+e+"SelectedPanel' class='"+o.panelClass+"' style='height:"+i+";'></div><div class='none "+o.ckClass+"' id='"+e+"CheckboxPanel'><div>","object"==typeof t.data&&t.data.sort(),n.after(s).bind("keyup",{settings:t},this._keyupAction).bind("keydown",function(e){t.chinese=e.keyCode,t.keydownVal=h(this).val()}).addClass(o.inputClass),t.tipNum=0},_keyupAction:function(e){var t=e.data.settings,i=h.completed._getCurrentWord(this,t);if(""===i.currentWord||27===e.keyCode||16===e.keyCode)return h("#"+this.id+"SelectedPanel").hide(),t.tipNum=0,void(t.afterKeyup&&t.afterKeyup(e));var o,n=h.completed._getMatchData(t.data,this.value,i.currentWord);38===e.keyCode&&(0<t.tipNum?t.tipNum--:t.tipNum=n.length-1),40===e.keyCode&&(t.tipNum<n.length-1?t.tipNum++:t.tipNum=0),h.completed._buildSelectedPanel(this.id,n,t,i.currentWord),13===e.keyCode&&n[t.tipNum]&&229!==t.chinese&&(o=this.value,this.value=o.substring(0,i.startPos)+n[t.tipNum]+o.substring(i.endPos,o.length),h("#"+this.id+"SelectedPanel").hide(),t.chinese=void 0),38!==e.keyCode&&40!==e.keyCode&&(t.tipNum=0),t.afterKeyup&&t.afterKeyup(e)},_getCurrentWord:function(e,t){var i=h(e).val(),o=!0,n=0,s=0,a=h.completed._defaults.separator;if(""===i)return{currentWord:"",startPos:s,endPos:n};if(document.selection)try{var l=document.selection.createRange(),d=e.createTextRange();d.collapse(!0),d.select();d=document.selection.createRange();d.setEndPoint("EndToEnd",l),t.curPos=d.text.length,l.select()}catch(e){delete e}else t.curPos=e.selectionStart;for(var c=t.curPos,r=0;r<i.length;r++)i.charAt(r)===a&&c<=r&&o&&(n=r,o=!1);!0===o&&(o=!1,n=i.length);for(var u=n;-1<u;u--)i.charAt(u)===a&&u<c&&!o&&(s=u+1,o=!0);return{currentWord:i.substring(s,n),startPos:s,endPos:n}},_getMatchData:function(e,t,i){for(var o=t.split(h.completed._defaults.separator),n=[],s=0;s<e.length;s++)if("number"==typeof e[s]&&(e[s]=e[s].toString()),-1<e[s].toLowerCase().indexOf(i.toLowerCase())){for(var a=!0,l=0;l<o.length;l++)e[s]===o[l].toString()&&e[s].toLowerCase()!==i.toLowerCase()&&(a=!1);a&&n.push(e[s])}return n},_mousemoveSelectPanel:function(e,t,i){h(e).parent().find("a").removeClass("selected"),e.className="selected",h.completed._getInst(document.getElementById(i)).settings.tipNum=t},_buildSelectedPanel:function(n,e,s,t){var i=h("#"+n+"SelectedPanel");if(0!==e.length){s.tipNum>=e.length&&(s.tipNum=0);for(var o="",a=0;a<e.length;a++){var l="",d=e[a].replace(t,"<b>"+t+"</b>");s.tipNum===a&&(l="class='selected'"),o+="<a href='javascript:void(0);'                                         onmousemove=\"$.completed._mousemoveSelectPanel(this, "+a+", '"+n+"');\"                                        "+l+">"+d+"</a>"}i.html(o).show();var c=h("#"+n+"SelectedPanel a.selected");c.position().top+i.scrollTop()>50-c.height()&&i.scrollTop(c.position().top+i.scrollTop()+c.height()-50),c.position().top<0&&i.scrollTop(i.scrollTop-c.height()),h("#"+n+"SelectedPanel a").click(function(){var e=document.getElementById(n),t=h.completed._getCurrentWord(document.getElementById(n),s),i=h.completed._getMatchData(s.data,e.value,t.currentWord),o=e.value;e.value=o.substring(0,t.startPos)+i[s.tipNum]+o.substring(t.endPos,o.length),s.tipNum=0,h(e).focus(),s.afterSelected&&s.afterSelected(h(this))})}else i.html("").hide()},_buildCheckboxPanel:function(e,t){for(var i="",o=h("#"+e),n=0;n<t.length;n++)i+="<span>"+t[n]+"</span>";h("#"+e+"CheckboxPanel").html(i+"<div class='clear'></div>"),h("#"+e+"CheckboxPanel span").click(function(){var e,t=o.val(),i=this.innerHTML;"selected"===this.className?(this.className="",e=t.substr(t.indexOf(i)+i.length,1),i===t||","!==e?o.val(t.replace(i,"")):o.val(t.replace(i+",",""))):(this.className="selected",""===t.replace(/\s/g,"")||","===t.substr(t.length-1,1)?o.val(t+i):o.val(t+","+i))}),this._matchChecked(e),o.blur(function(){h.completed._matchChecked(e)})},_matchChecked:function(e){var t=h("#"+e).val().split(",");h("#"+e+"CheckboxPanel span").removeClass().each(function(){for(var e=0;e<t.length;e++)this.innerHTML===t[e]&&(this.className="selected")})},_updateDataCompleted:function(e,t,i){var o=this._getInst(e),e=o.id,o=o.settings;o.data=i,h.completed._buildSelectedPanel(e,i,o,h("#"+e).val())},_getDefaults:function(e,t,i){if("styleClass"===i){if("default"===t.theme||void 0===t.theme)return e.styleClass;for(var o in t.styleClass={},e[i])t.styleClass[o]=t.theme+"-"+e.styleClass[o]}else{if("height"===i||"width"===i)return null===t[i]||void 0===t[i]?"auto":t[i]+"px";if(null===t[i]||void 0===t[i])return e[i]}return t[i]}}),h.fn.completed=function(e){var t=Array.prototype.slice.call(arguments);return this.each(function(){"string"==typeof e?h.completed["_"+e+"Completed"].apply(h.completed,[this].concat(t)):h.completed._attach(this,e)})},h.completed=new e,window["DP_jQuery_"+t]=h}(jQuery);
!function(r,p){"use strict";var c="function",u="undefined",m="object",i="model",s="name",e="type",o="vendor",n="version",a="architecture",t="console",w="mobile",l="tablet",d="smarttv",f="wearable",b={extend:function(i,s){var e,o={};for(e in i)s[e]&&s[e].length%2==0?o[e]=s[e].concat(i[e]):o[e]=i[e];return o},has:function(i,s){return"string"==typeof i&&-1!==s.toLowerCase().indexOf(i.toLowerCase())},lowerize:function(i){return i.toLowerCase()},major:function(i){return"string"==typeof i?i.split(".")[0]:p}},g={rgx:function(){for(var i,s,e,o,r,n,a,t=0,w=arguments;t<w.length&&!n;){var l=w[t],d=w[t+1];if(typeof i==u)for(o in i={},d)d.hasOwnProperty(o)&&(typeof(r=d[o])==m?i[r[0]]=p:i[r]=p);for(s=e=0;s<l.length&&!n;)if(n=l[s++].exec(this.getUA()))for(o=0;o<d.length;o++)a=n[++e],typeof(r=d[o])==m&&0<r.length?2==r.length?typeof r[1]==c?i[r[0]]=r[1].call(this,a):i[r[0]]=r[1]:3==r.length?typeof r[1]!=c||r[1].exec&&r[1].test?i[r[0]]=a?a.replace(r[1],r[2]):p:i[r[0]]=a?r[1].call(this,a,r[2]):p:4==r.length&&(i[r[0]]=a?r[3].call(this,a.replace(r[1],r[2])):p):i[r]=a||p;t+=2}return i},str:function(i,s){for(var e in s)if(typeof s[e]==m&&0<s[e].length){for(var o=0;o<s[e].length;o++)if(b.has(s[e][o],i))return"?"===e?p:e}else if(b.has(s[e],i))return"?"===e?p:e;return i}},h={browser:{oldsafari:{version:{"1.0":"/8",1.2:"/1",1.3:"/3","2.0":"/412","2.0.2":"/416","2.0.3":"/417","2.0.4":"/419","?":"/"}}},device:{amazon:{model:{"Fire Phone":["SD","KF"]}},sprint:{model:{"Evo Shift 4G":"7373KT"},vendor:{HTC:"APA",Sprint:"Sprint"}}},os:{windows:{version:{ME:"4.90","NT 3.11":"NT3.51","NT 4.0":"NT4.0",2e3:"NT 5.0",XP:["NT 5.1","NT 5.2"],Vista:"NT 6.0",7:"NT 6.1",8:"NT 6.2",8.1:"NT 6.3",10:["NT 6.4","NT 10.0"],RT:"ARM"}}}},v={browser:[[/(opera\smini)\/([\w\.-]+)/i,/(opera\s[mobiletab]+).+version\/([\w\.-]+)/i,/(opera).+version\/([\w\.]+)/i,/(opera)[\/\s]+([\w\.]+)/i],[s,n],[/(OPiOS)[\/\s]+([\w\.]+)/i],[[s,"Opera Mini"],n],[/\s(opr)\/([\w\.]+)/i],[[s,"Opera"],n],[/(kindle)\/([\w\.]+)/i,/(lunascape|maxthon|netfront|jasmine|blazer)[\/\s]?([\w\.]+)*/i,/(avant\s|iemobile|slim|baidu)(?:browser)?[\/\s]?([\w\.]*)/i,/(?:ms|\()(ie)\s([\w\.]+)/i,/(rekonq)\/([\w\.]+)*/i,/(chromium|flock|rockmelt|midori|epiphany|silk|skyfire|ovibrowser|bolt|iron|vivaldi|iridium|phantomjs)\/([\w\.-]+)/i],[s,n],[/(trident).+rv[:\s]([\w\.]+).+like\sgecko/i],[[s,"IE"],n],[/(edge)\/((\d+)?[\w\.]+)/i],[s,n],[/(yabrowser)\/([\w\.]+)/i],[[s,"Yandex"],n],[/(comodo_dragon)\/([\w\.]+)/i],[[s,/_/g," "],n],[/(chrome|omniweb|arora|[tizenoka]{5}\s?browser)\/v?([\w\.]+)/i,/(qqbrowser)[\/\s]?([\w\.]+)/i],[s,n],[/(uc\s?browser)[\/\s]?([\w\.]+)/i,/ucweb.+(ucbrowser)[\/\s]?([\w\.]+)/i,/JUC.+(ucweb)[\/\s]?([\w\.]+)/i],[[s,"UCBrowser"],n],[/(dolfin)\/([\w\.]+)/i],[[s,"Dolphin"],n],[/((?:android.+)crmo|crios)\/([\w\.]+)/i],[[s,"Chrome"],n],[/XiaoMi\/MiuiBrowser\/([\w\.]+)/i],[n,[s,"MIUI Browser"]],[/android.+version\/([\w\.]+)\s+(?:mobile\s?safari|safari)/i],[n,[s,"Android Browser"]],[/FBAV\/([\w\.]+);/i],[n,[s,"Facebook"]],[/fxios\/([\w\.-]+)/i],[n,[s,"Firefox"]],[/version\/([\w\.]+).+?mobile\/\w+\s(safari)/i],[n,[s,"Mobile Safari"]],[/version\/([\w\.]+).+?(mobile\s?safari|safari)/i],[n,s],[/webkit.+?(mobile\s?safari|safari)(\/[\w\.]+)/i],[s,[n,g.str,h.browser.oldsafari.version]],[/(konqueror)\/([\w\.]+)/i,/(webkit|khtml)\/([\w\.]+)/i],[s,n],[/(navigator|netscape)\/([\w\.-]+)/i],[[s,"Netscape"],n],[/(swiftfox)/i,/(icedragon|iceweasel|camino|chimera|fennec|maemo\sbrowser|minimo|conkeror)[\/\s]?([\w\.\+]+)/i,/(firefox|seamonkey|k-meleon|icecat|iceape|firebird|phoenix)\/([\w\.-]+)/i,/(mozilla)\/([\w\.]+).+rv\:.+gecko\/\d+/i,/(polaris|lynx|dillo|icab|doris|amaya|w3m|netsurf|sleipnir)[\/\s]?([\w\.]+)/i,/(links)\s\(([\w\.]+)/i,/(gobrowser)\/?([\w\.]+)*/i,/(ice\s?browser)\/v?([\w\._]+)/i,/(mosaic)[\/\s]([\w\.]+)/i],[s,n]],cpu:[[/(?:(amd|x(?:(?:86|64)[_-])?|wow|win)64)[;\)]/i],[[a,"amd64"]],[/(ia32(?=;))/i],[[a,b.lowerize]],[/((?:i[346]|x)86)[;\)]/i],[[a,"ia32"]],[/windows\s(ce|mobile);\sppc;/i],[[a,"arm"]],[/((?:ppc|powerpc)(?:64)?)(?:\smac|;|\))/i],[[a,/ower/,"",b.lowerize]],[/(sun4\w)[;\)]/i],[[a,"sparc"]],[/((?:avr32|ia64(?=;))|68k(?=\))|arm(?:64|(?=v\d+;))|(?=atmel\s)avr|(?:irix|mips|sparc)(?:64)?(?=;)|pa-risc)/i],[[a,b.lowerize]]],device:[[/\((ipad|playbook);[\w\s\);-]+(rim|apple)/i],[i,o,[e,l]],[/applecoremedia\/[\w\.]+ \((ipad)/],[i,[o,"Apple"],[e,l]],[/(apple\s{0,1}tv)/i],[[i,"Apple TV"],[o,"Apple"]],[/(archos)\s(gamepad2?)/i,/(hp).+(touchpad)/i,/(kindle)\/([\w\.]+)/i,/\s(nook)[\w\s]+build\/(\w+)/i,/(dell)\s(strea[kpr\s\d]*[\dko])/i],[o,i,[e,l]],[/(kf[A-z]+)\sbuild\/[\w\.]+.*silk\//i],[i,[o,"Amazon"],[e,l]],[/(sd|kf)[0349hijorstuw]+\sbuild\/[\w\.]+.*silk\//i],[[i,g.str,h.device.amazon.model],[o,"Amazon"],[e,w]],[/\((ip[honed|\s\w*]+);.+(apple)/i],[i,o,[e,w]],[/\((ip[honed|\s\w*]+);/i],[i,[o,"Apple"],[e,w]],[/(blackberry)[\s-]?(\w+)/i,/(blackberry|benq|palm(?=\-)|sonyericsson|acer|asus|dell|huawei|meizu|motorola|polytron)[\s_-]?([\w-]+)*/i,/(hp)\s([\w\s]+\w)/i,/(asus)-?(\w+)/i],[o,i,[e,w]],[/\(bb10;\s(\w+)/i],[i,[o,"BlackBerry"],[e,w]],[/android.+(transfo[prime\s]{4,10}\s\w+|eeepc|slider\s\w+|nexus 7)/i],[i,[o,"Asus"],[e,l]],[/(sony)\s(tablet\s[ps])\sbuild\//i,/(sony)?(?:sgp.+)\sbuild\//i],[[o,"Sony"],[i,"Xperia Tablet"],[e,l]],[/(?:sony)?(?:(?:(?:c|d)\d{4})|(?:so[-l].+))\sbuild\//i],[[o,"Sony"],[i,"Xperia Phone"],[e,w]],[/\s(ouya)\s/i,/(nintendo)\s([wids3u]+)/i],[o,i,[e,t]],[/android.+;\s(shield)\sbuild/i],[i,[o,"Nvidia"],[e,t]],[/(playstation\s[34portablevi]+)/i],[i,[o,"Sony"],[e,t]],[/(sprint\s(\w+))/i],[[o,g.str,h.device.sprint.vendor],[i,g.str,h.device.sprint.model],[e,w]],[/(lenovo)\s?(S(?:5000|6000)+(?:[-][\w+]))/i],[o,i,[e,l]],[/(htc)[;_\s-]+([\w\s]+(?=\))|\w+)*/i,/(zte)-(\w+)*/i,/(alcatel|geeksphone|huawei|lenovo|nexian|panasonic|(?=;\s)sony)[_\s-]?([\w-]+)*/i],[o,[i,/_/g," "],[e,w]],[/(nexus\s9)/i],[i,[o,"HTC"],[e,l]],[/[\s\(;](xbox(?:\sone)?)[\s\);]/i],[i,[o,"Microsoft"],[e,t]],[/(kin\.[onetw]{3})/i],[[i,/\./g," "],[o,"Microsoft"],[e,w]],[/\s(milestone|droid(?:[2-4x]|\s(?:bionic|x2|pro|razr))?(:?\s4g)?)[\w\s]+build\//i,/mot[\s-]?(\w+)*/i,/(XT\d{3,4}) build\//i,/(nexus\s[6])/i],[i,[o,"Motorola"],[e,w]],[/android.+\s(mz60\d|xoom[\s2]{0,2})\sbuild\//i],[i,[o,"Motorola"],[e,l]],[/android.+((sch-i[89]0\d|shw-m380s|gt-p\d{4}|gt-n8000|sgh-t8[56]9|nexus 10))/i,/((SM-T\w+))/i],[[o,"Samsung"],i,[e,l]],[/((s[cgp]h-\w+|gt-\w+|galaxy\snexus|sm-n900))/i,/(sam[sung]*)[\s-]*(\w+-?[\w-]*)*/i,/sec-((sgh\w+))/i],[[o,"Samsung"],i,[e,w]],[/(samsung);smarttv/i],[o,i,[e,d]],[/\(dtv[\);].+(aquos)/i],[i,[o,"Sharp"],[e,d]],[/sie-(\w+)*/i],[i,[o,"Siemens"],[e,w]],[/(maemo|nokia).*(n900|lumia\s\d+)/i,/(nokia)[\s_-]?([\w-]+)*/i],[[o,"Nokia"],i,[e,w]],[/android\s3\.[\s\w;-]{10}(a\d{3})/i],[i,[o,"Acer"],[e,l]],[/android\s3\.[\s\w;-]{10}(lg?)-([06cv9]{3,4})/i],[[o,"LG"],i,[e,l]],[/(lg) netcast\.tv/i],[o,i,[e,d]],[/(nexus\s[45])/i,/lg[e;\s\/-]+(\w+)*/i],[i,[o,"LG"],[e,w]],[/android.+(ideatab[a-z0-9\-\s]+)/i],[i,[o,"Lenovo"],[e,l]],[/linux;.+((jolla));/i],[o,i,[e,w]],[/((pebble))app\/[\d\.]+\s/i],[o,i,[e,f]],[/android.+;\s(glass)\s\d/i],[i,[o,"Google"],[e,f]],[/android.+(\w+)\s+build\/hm\1/i,/android.+(hm[\s\-_]*note?[\s_]*(?:\d\w)?)\s+build/i,/android.+(mi[\s\-_]*(?:one|one[\s_]plus)?[\s_]*(?:\d\w)?)\s+build/i],[[i,/_/g," "],[o,"Xiaomi"],[e,w]],[/\s(tablet)[;\/\s]/i,/\s(mobile)[;\/\s]/i],[[e,b.lowerize],o,i]],engine:[[/windows.+\sedge\/([\w\.]+)/i],[n,[s,"EdgeHTML"]],[/(presto)\/([\w\.]+)/i,/(webkit|trident|netfront|netsurf|amaya|lynx|w3m)\/([\w\.]+)/i,/(khtml|tasman|links)[\/\s]\(?([\w\.]+)/i,/(icab)[\/\s]([23]\.[\d\.]+)/i],[s,n],[/rv\:([\w\.]+).*(gecko)/i],[n,s]],os:[[/microsoft\s(windows)\s(vista|xp)/i],[s,n],[/(windows)\snt\s6\.2;\s(arm)/i,/(windows\sphone(?:\sos)*|windows\smobile|windows)[\s\/]?([ntce\d\.\s]+\w)/i],[s,[n,g.str,h.os.windows.version]],[/(win(?=3|9|n)|win\s9x\s)([nt\d\.]+)/i],[[s,"Windows"],[n,g.str,h.os.windows.version]],[/\((bb)(10);/i],[[s,"BlackBerry"],n],[/(blackberry)\w*\/?([\w\.]+)*/i,/(tizen)[\/\s]([\w\.]+)/i,/(android|webos|palm\sos|qnx|bada|rim\stablet\sos|meego|contiki)[\/\s-]?([\w\.]+)*/i,/linux;.+(sailfish);/i],[s,n],[/(symbian\s?os|symbos|s60(?=;))[\/\s-]?([\w\.]+)*/i],[[s,"Symbian"],n],[/\((series40);/i],[s],[/mozilla.+\(mobile;.+gecko.+firefox/i],[[s,"Firefox OS"],n],[/(nintendo|playstation)\s([wids34portablevu]+)/i,/(mint)[\/\s\(]?(\w+)*/i,/(mageia|vectorlinux)[;\s]/i,/(joli|[kxln]?ubuntu|debian|[open]*suse|gentoo|(?=\s)arch|slackware|fedora|mandriva|centos|pclinuxos|redhat|zenwalk|linpus)[\/\s-]?([\w\.-]+)*/i,/(hurd|linux)\s?([\w\.]+)*/i,/(gnu)\s?([\w\.]+)*/i],[s,n],[/(cros)\s[\w]+\s([\w\.]+\w)/i],[[s,"Chromium OS"],n],[/(sunos)\s?([\w\.]+\d)*/i],[[s,"Solaris"],n],[/\s([frentopc-]{0,4}bsd|dragonfly)\s?([\w\.]+)*/i],[s,n],[/(ip[honead]+)(?:.*os\s([\w]+)*\slike\smac|;\sopera)/i],[[s,"iOS"],[n,/_/g,"."]],[/(mac\sos\sx)\s?([\w\s\.]+\w)*/i,/(macintosh|mac(?=_powerpc)\s)/i],[[s,"Mac OS"],[n,/_/g,"."]],[/((?:open)?solaris)[\/\s-]?([\w\.]+)*/i,/(haiku)\s(\w+)/i,/(aix)\s((\d)(?=\.|\)|\s)[\w\.]*)*/i,/(plan\s9|minix|beos|os\/2|amigaos|morphos|risc\sos|openvms)/i,/(unix)\s?([\w\.]+)*/i],[s,n]]},x=function(i,s){if(!(this instanceof x))return new x(i,s).getResult();var e=i||(r&&r.navigator&&r.navigator.userAgent?r.navigator.userAgent:""),o=s?b.extend(v,s):v;return this.getBrowser=function(){var i=g.rgx.apply(this,o.browser);return i.major=b.major(i.version),i},this.getCPU=function(){return g.rgx.apply(this,o.cpu)},this.getDevice=function(){return g.rgx.apply(this,o.device)},this.getEngine=function(){return g.rgx.apply(this,o.engine)},this.getOS=function(){return g.rgx.apply(this,o.os)},this.getResult=function(){return{ua:this.getUA(),browser:this.getBrowser(),engine:this.getEngine(),os:this.getOS(),device:this.getDevice(),cpu:this.getCPU()}},this.getUA=function(){return e},this.setUA=function(i){return e=i,this},this};x.VERSION="0.7.10",x.BROWSER={NAME:s,MAJOR:"major",VERSION:n},x.CPU={ARCHITECTURE:a},x.DEVICE={MODEL:i,VENDOR:o,TYPE:e,CONSOLE:t,MOBILE:w,SMARTTV:d,TABLET:l,WEARABLE:f,EMBEDDED:"embedded"},x.ENGINE={NAME:s,VERSION:n},x.OS={NAME:s,VERSION:n},typeof exports!=u?(typeof module!=u&&module.exports&&(exports=module.exports=x),exports.UAParser=x):typeof define==c&&define.amd?define("ua-parser-js",[],function(){return x}):r.UAParser=x;var y,k=r.jQuery||r.Zepto;typeof k!=u&&(y=new x,k.ua=y.getResult(),k.ua.get=function(){return y.getUA()},k.ua.set=function(i){y.setUA(i);var s,e=y.getResult();for(s in e)k.ua[s]=e[s]})}("object"==typeof window?window:this);
...
!function(r){var l={support:{pjax:window.history&&window.history.pushState&&window.history.replaceState&&!navigator.userAgent.match(/(iPod|iPhone|iPad|WebApps\/.+CFNetwork)/),storage:!!window.localStorage},toInt:function(t){return parseInt(t)},stack:{},getTime:function(){return+new Date},getRealUrl:function(t){return t=(t=(t||"").replace(/\#.*?$/,"")).replace("?pjax=true&","?").replace("?pjax=true","").replace("&pjax=true","")},getUrlHash:function(t){return t.replace(/^[^\#]*(?:\#(.*?))?$/,"$1")},getLocalKey:function(t){t="pjax_"+encodeURIComponent(t);return{data:t+"_data",time:t+"_time",title:t+"_title"}},removeAllCache:function(){if(l.support.storage)for(var t in localStorage)"pjax"===(t.split("_")||[""])[0]&&delete localStorage[t]},getCache:function(t,e,o){if(e=l.toInt(e),t in l.stack){if(a=l.stack[t],ctime=l.getTime(),a.time+1e3*e>ctime)return a;delete l.stack[t]}else if(o&&l.support.storage){var a,n=l.getLocalKey(t),o=n.data,t=n.time;if(a=localStorage.getItem(o)){if(l.toInt(localStorage.getItem(t))+1e3*e>l.getTime())return{data:a,title:localStorage.getItem(n.title)};localStorage.removeItem(o),localStorage.removeItem(t),localStorage.removeItem(n.title)}}return null},setCache:function(t,e,o,a){var n=l.getTime();l.stack[t]={data:e,title:o,time:n},a&&l.support.storage&&(t=l.getLocalKey(t),localStorage.setItem(t.data,e),localStorage.setItem(t.time,n),localStorage.setItem(t.title,o))},removeCache:function(t){t=l.getRealUrl(t||location.href),delete l.stack[t],l.support.storage&&(t=l.getLocalKey(t),localStorage.removeItem(t.data),localStorage.removeItem(t.time),localStorage.removeItem(t.title))}},i=function(a){if(!(a=r.extend({selector:"",container:"",callback:function(){},filter:function(){}},a)).container||!a.selector)throw new Error("selector & container options must be set");r("body").delegate(a.selector,"click",function(t){if(1<t.which||t.metaKey)return!0;var e=r(this).attr("href");if("function"==typeof a.filter&&!0===a.filter.call(this,e,this))return!0;if(e===location.href)return!0;if(l.getRealUrl(e)==l.getRealUrl(location.href)){var o=l.getUrlHash(e);return o&&(location.hash=o,a.callback&&a.callback.call(this,{type:"hash"})),!0}t.preventDefault(),a=r.extend(!0,a,{url:e,element:this,push:!0}),i.request(a)})};i.xhr=null,i.options={},i.state={},i.defaultOptions={timeout:2e3,element:null,cache:86400,storage:!0,url:"",push:!0,show:"",title:"",titleSuffix:"",type:"GET",data:{pjax:!0},dataType:"html",callback:null,beforeSend:function(t){r(i.options.container).trigger("pjax.start",[t,i.options]),t&&t.setRequestHeader("X-PJAX",!0)&&t.setRequestHeader("X-PJAX-Container",i.options.container)},error:function(){i.options.callback&&i.options.callback.call(i.options.element,{type:"error"}),location.href=i.options.url},complete:function(t){r(i.options.container).trigger("pjax.end",[t,i.options])}},i.showFx={_default:function(t,e,o){this.html(t),e&&e.call(this,t,o)},fade:function(t,e,o){var a=this;o?(a.html(t),e&&e.call(a,t,o)):this.fadeOut(200,function(){a.html(t).fadeIn(200,function(){e&&e.call(a,t,o)})})}},i.showFn=function(t,e,o,a,n){var l=null;(l="function"==typeof t?t:(t in i.showFx||(t="_default"),i.showFx[t]))&&l.call(e,o,function(){var t=location.hash;""!=t?(location.href=t,/Firefox/.test(navigator.userAgent)&&history.replaceState(r.extend({},i.state,{url:null}),document.title)):1<location.search.length&&window.scrollTo(0,0),a&&a.call(this,o,n)},n)},i.success=function(t,e){if(!0!==e&&(e=!1),i.html&&(t=r(t).find(i.html).html()),-1!=(t||"").indexOf("<html"))return i.options.callback&&i.options.callback.call(i.options.element,{type:"error"}),location.href=i.options.url,!1;var o=r(i.options.element).attr("pjax-title");o||(""==(o=i.options.title||"")&&i.options.element&&(o=(a=r(i.options.element)).attr("title")||a.text()),(a=t.match(/<title>(.*?)<\/title>/))&&(o=a[1])),o&&-1==o.indexOf(i.options.titleSuffix)&&(o+=i.options.titleSuffix),document.title=o,i.state={container:i.options.container,timeout:i.options.timeout,cache:i.options.cache,storage:i.options.storage,show:i.options.show,title:o,url:i.options.oldUrl};var a=r.param(i.options.data);""!=a&&(i.state.url=i.options.url+(/\?/.test(i.options.url)?"&":"?")+a),i.options.push?(i.active||(history.replaceState(r.extend({},i.state,{url:null}),document.title),i.active=!0),history.pushState(i.state,document.title,i.options.oldUrl)):!1===i.options.push&&history.replaceState(i.state,document.title,i.options.oldUrl),i.options.showFn&&i.options.showFn(t,function(){i.options.callback&&i.options.callback.call(i.options.element,{type:e?"cache":"success"})},e),i.options.cache&&!e&&l.setCache(i.options.url,t,o,i.options.storage)},i.request=function(a){a.hasOwnProperty("data")&&(i.defaultOptions.data=a.data),a=r.extend(!0,i.defaultOptions,a);var t,n=r(a.container);if(a.oldUrl=a.url,a.url=l.getRealUrl(a.url),r(a.element).length&&(t=l.toInt(r(a.element).attr("data-pjax-cache")))&&(a.cache=t),!0===a.cache&&(a.cache=86400),a.cache=l.toInt(a.cache),0===a.cache&&l.removeAllCache(),a.showFn||(a.showFn=function(t,e,o){i.showFn(a.show,n,t,e,o)}),i.options=a,i.options.success=i.success,a.cache&&(t=l.getCache(a.url,a.cache,a.storage)))return a.beforeSend(),a.title=t.title,i.success(t.data,!0),a.complete(),!0;i.xhr&&i.xhr.readyState<4&&(i.xhr.onreadystatechange=r.noop,i.xhr.abort()),i.xhr=r.ajax(i.options)};var o="state"in window.history,a=location.href;r(window).bind("popstate",function(t){var e=!o&&location.href==a;o=!0,e||(t=t.state)&&t.container&&(r(t.container).length?(t={url:t.url,container:t.container,push:null,timeout:t.timeout,cache:t.cache,storage:t.storage,title:t.title,element:null},i.request(t)):window.location=location.href)}),l.support.pjax||((i=function(){return!0}).request=function(t){t&&t.url&&(location.href=t.url)}),r.pjax=i,r.pjax.util=l,"state"in r.Event.prototype||r.event.addProp("state")}(jQuery);
